...
class RefereesControllerTest < ActionController::TestCase
  ...
  test "should create referee" do
    assert_difference('Referee.count') do
      post :create, referee: { country_id: @referee.country_id, dateOfBirth: @referee.dateOfBirth, firstName: @referee.firstName, isActive: @referee.isActive, lastName: @referee.lastName }
    end
  ...
  test "should update referee" do
    patch :update, id: @referee, referee: { country_id: @referee.country_id, dateOfBirth: @referee.dateOfBirth, firstName: @referee.firstName, isActive: @referee.isActive, lastName: @referee.lastName }
    assert_redirected_to referee_path(assigns(:referee))
  end
