...
class ParticipationsControllerTest < ActionController::TestCase
  ...
  test "should create participation" do
    assert_difference('Participation.count') do
      post :create, participation: { is_admin: @participation.is_admin, poule_id: @participation.poule_id, user_id: @participation.user_id }
    end
  ...
  test "should update participation" do
    patch :update, id: @participation, participation: { is_admin: @participation.is_admin, poule_id: @participation.poule_id, user_id: @participation.user_id }
    assert_redirected_to participation_path(assigns(:participation))
  end
